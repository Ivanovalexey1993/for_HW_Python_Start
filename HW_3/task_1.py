...
for value in hike.values():
    things += value
print(f"1. Вещи, которые взяли  3 друга: {set(things)}")
...
print(f"2. Уникальные вещи, есть только у 1 друга. {new_dict}")
print("3. Вещи есть у всех друзей кроме 1  имя того, у кого данная вещь отсутствует.", name_not)